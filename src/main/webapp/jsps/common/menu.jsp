...
<nav class="rg-site-nav" id="nav">
	<div class="row">
		<ul id="dropdown">
			<li><a title="" href="/pickdata/user/load.ls">Customer</a></li>
			<li><a title="" href="/pickdata/user/loadUser.ls">User Management</a></li>
			<li><a title="" href="/pickdata/user/conf.ls">Configuration</a></li>
			<li><a title="" href="/pickdata/grab/load.ls">Grab</a></li>
		</ul>
	</div>
</nav>